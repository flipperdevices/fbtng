...
#define FURI_HAL_OSPI_FUNCTIONAL_MODE_INDIRECT_WRITE \
    ((uint32_t)0x00000000) /*!< Indirect write mode    */
#define FURI_HAL_OSPI_FUNCTIONAL_MODE_INDIRECT_READ \
    ((uint32_t)OCTOSPI_CR_FMODE_0) /*!< Indirect read mode     */
#define FURI_HAL_OSPI_FUNCTIONAL_MODE_AUTO_POLLING \
    ((uint32_t)OCTOSPI_CR_FMODE_1) /*!< Automatic polling mode */
#define FURI_HAL_OSPI_FUNCTIONAL_MODE_MEMORY_MAPPED \
...
/** @defgroup OSPI_ClockMode OSPI Clock Mode
  * @{
  */
#define FURI_HAL_OSPI_CLOCK_MODE_0 \
    ((uint32_t)0x00000000U) /*!< CLK must stay low while nCS is high  */
...
#define FURI_HAL_OSPI_MEMTYPE_MACRONIX_RAM \
...
/** @defgroup OSPI_FreeRunningClock OSPI Free Running Clock
  * @{
  */
#define FURI_HAL_OSPI_FREERUNCLK_DISABLE \
...
/** @defgroup OSPI_DelayBlockBypass OSPI Delay Block Bypaas
  * @{
  */
#define FURI_HAL_OSPI_DELAY_BLOCK_USED \
    ((uint32_t)0x00000000U) /*!< Sampling clock is delayed by the delay block */
...
/** @defgroup OSPI_TimeOutActivation OSPI Timeout Activation
  * @{
  */
#define FURI_HAL_OSPI_TIMEOUT_COUNTER_DISABLE \
    ((uint32_t)0x00000000U) /*!< Timeout counter disabled, nCS remains active               */
#define FURI_HAL_OSPI_TIMEOUT_COUNTER_ENABLE \
...
#define FURI_HAL_OSPIM_IOPORT_1_LOW \
    ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x1U)) /*!< Port 1 - IO[3:0] */
#define FURI_HAL_OSPIM_IOPORT_1_HIGH \
    ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x1U)) /*!< Port 1 - IO[7:4] */
#define FURI_HAL_OSPIM_IOPORT_2_LOW \
    ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x2U)) /*!< Port 2 - IO[3:0] */
#define FURI_HAL_OSPIM_IOPORT_2_HIGH \
    ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x2U)) /*!< Port 2 - IO[7:4] */
#define FURI_HAL_OSPIM_IOPORT_3_LOW \
    ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x3U)) /*!< Port 3 - IO[3:0] */
#define FURI_HAL_OSPIM_IOPORT_3_HIGH \
    ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x3U)) /*!< Port 3 - IO[7:4] */
#define FURI_HAL_OSPIM_IOPORT_4_LOW \
    ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x4U)) /*!< Port 4 - IO[3:0] */
#define FURI_HAL_OSPIM_IOPORT_4_HIGH \
    ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x4U)) /*!< Port 4 - IO[7:4] */
#define FURI_HAL_OSPIM_IOPORT_5_LOW \
    ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x5U)) /*!< Port 5 - IO[3:0] */
#define FURI_HAL_OSPIM_IOPORT_5_HIGH \
    ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x5U)) /*!< Port 5 - IO[7:4] */
#define FURI_HAL_OSPIM_IOPORT_6_LOW \
    ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x6U)) /*!< Port 6 - IO[3:0] */
#define FURI_HAL_OSPIM_IOPORT_6_HIGH \
    ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x6U)) /*!< Port 6 - IO[7:4] */
#define FURI_HAL_OSPIM_IOPORT_7_LOW \
    ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x7U)) /*!< Port 7 - IO[3:0] */
#define FURI_HAL_OSPIM_IOPORT_7_HIGH \
    ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x7U)) /*!< Port 7 - IO[7:4] */
#define FURI_HAL_OSPIM_IOPORT_8_LOW \
    ((uint32_t)(OCTOSPIM_PCR_IOLEN | 0x8U)) /*!< Port 8 - IO[3:0] */
#define FURI_HAL_OSPIM_IOPORT_8_HIGH \
    ((uint32_t)(OCTOSPIM_PCR_IOHEN | 0x8U)) /*!< Port 8 - IO[7:4] */
/**
  * @}
  */
...
/** @defgroup OSPI_OperationType OSPI Operation Type
  * @{
  */
#define FURI_HAL_OSPI_OPTYPE_COMMON_CFG \
    ((uint32_t)0x00000000U) /*!< Common configuration (indirect or auto-polling mode) */
#define FURI_HAL_OSPI_OPTYPE_READ_CFG \
    ((uint32_t)0x00000001U) /*!< Read configuration (memory-mapped mode)              */
#define FURI_HAL_OSPI_OPTYPE_WRITE_CFG \
    ((uint32_t)0x00000002U) /*!< Write configuration (memory-mapped mode)             */
#define FURI_HAL_OSPI_OPTYPE_WRAP_CFG \
    ((uint32_t)0x00000003U) /*!< Wrap configuration (memory-mapped mode)              */
/**
  * @}
  */
...
#define FURI_HAL_OSPI_INSTRUCTION_1_LINE \
    ((uint32_t)OCTOSPI_CCR_IMODE_0) /*!< Instruction on a single line */
#define FURI_HAL_OSPI_INSTRUCTION_2_LINES \
    ((uint32_t)OCTOSPI_CCR_IMODE_1) /*!< Instruction on two lines     */
#define FURI_HAL_OSPI_INSTRUCTION_4_LINES \
    ((uint32_t)(OCTOSPI_CCR_IMODE_0 | OCTOSPI_CCR_IMODE_1)) /*!< Instruction on four lines    */
#define FURI_HAL_OSPI_INSTRUCTION_8_LINES \
    ((uint32_t)OCTOSPI_CCR_IMODE_2) /*!< Instruction on eight lines   */
/**
  * @}
  */
...
#define FURI_HAL_OSPI_INSTRUCTION_16_BITS \
    ((uint32_t)OCTOSPI_CCR_ISIZE_0) /*!< 16-bit instruction */
#define FURI_HAL_OSPI_INSTRUCTION_24_BITS \
...
/** @defgroup OSPI_InstructionDtrMode OSPI Instruction DTR Mode
  * @{
  */
#define FURI_HAL_OSPI_INSTRUCTION_DTR_DISABLE \
    ((uint32_t)0x00000000U) /*!< DTR mode disabled for instruction phase */
#define FURI_HAL_OSPI_INSTRUCTION_DTR_ENABLE \
    ((uint32_t)OCTOSPI_CCR_IDTR) /*!< DTR mode enabled for instruction phase  */
/**
  * @}
  */
...
#define FURI_HAL_OSPI_ADDRESS_1_LINE \
    ((uint32_t)OCTOSPI_CCR_ADMODE_0) /*!< Address on a single line */
#define FURI_HAL_OSPI_ADDRESS_2_LINES \
    ((uint32_t)OCTOSPI_CCR_ADMODE_1) /*!< Address on two lines     */
#define FURI_HAL_OSPI_ADDRESS_4_LINES \
    ((uint32_t)(OCTOSPI_CCR_ADMODE_0 | OCTOSPI_CCR_ADMODE_1)) /*!< Address on four lines    */
#define FURI_HAL_OSPI_ADDRESS_8_LINES \
...
/** @defgroup OSPI_AddressDtrMode OSPI Address DTR Mode
  * @{
  */
#define FURI_HAL_OSPI_ADDRESS_DTR_DISABLE \
    ((uint32_t)0x00000000U) /*!< DTR mode disabled for address phase */
#define FURI_HAL_OSPI_ADDRESS_DTR_ENABLE \
    ((uint32_t)OCTOSPI_CCR_ADDTR) /*!< DTR mode enabled for address phase  */
/**
  * @}
  */
...
/** @defgroup OSPI_AlternateBytesMode OSPI Alternate Bytes Mode
  * @{
  */
#define FURI_HAL_OSPI_ALTERNATE_BYTES_NONE \
    ((uint32_t)0x00000000U) /*!< No alternate bytes               */
#define FURI_HAL_OSPI_ALTERNATE_BYTES_1_LINE \
    ((uint32_t)OCTOSPI_CCR_ABMODE_0) /*!< Alternate bytes on a single line */
#define FURI_HAL_OSPI_ALTERNATE_BYTES_2_LINES \
    ((uint32_t)OCTOSPI_CCR_ABMODE_1) /*!< Alternate bytes on two lines     */
#define FURI_HAL_OSPI_ALTERNATE_BYTES_4_LINES \
    ((uint32_t)(OCTOSPI_CCR_ABMODE_0 |        \
                OCTOSPI_CCR_ABMODE_1)) /*!< Alternate bytes on four lines    */
#define FURI_HAL_OSPI_ALTERNATE_BYTES_8_LINES \
    ((uint32_t)OCTOSPI_CCR_ABMODE_2) /*!< Alternate bytes on eight lines   */
/**
  * @}
  */
...
#define FURI_HAL_OSPI_DATA_4_LINES \
    ((uint32_t)(OCTOSPI_CCR_DMODE_0 | OCTOSPI_CCR_DMODE_1)) /*!< Data on four lines    */
...
/** @defgroup OSPI_DataDtrMode OSPI Data DTR Mode
  * @{
  */
#define FURI_HAL_OSPI_DATA_DTR_DISABLE \
    ((uint32_t)0x00000000U) /*!< DTR mode disabled for data phase */
#define FURI_HAL_OSPI_DATA_DTR_ENABLE \
    ((uint32_t)OCTOSPI_CCR_DDTR) /*!< DTR mode enabled for data phase  */
/**
  * @}
  */
...
/** @defgroup OSPI_SIOOMode OSPI SIOO Mode
  * @{
  */
#define FURI_HAL_OSPI_SIOO_INST_EVERY_CMD \
    ((uint32_t)0x00000000U) /*!< Send instruction on every transaction       */
#define FURI_HAL_OSPI_SIOO_INST_ONLY_FIRST_CMD \
...
#define FURI_HAL_OSPI_ALTERNATE_BYTES_16_BITS \
    ((uint32_t)OCTOSPI_CCR_ABSIZE_0) /*!< 16-bit alternate bytes */
#define FURI_HAL_OSPI_ALTERNATE_BYTES_24_BITS \
    ((uint32_t)OCTOSPI_CCR_ABSIZE_1) /*!< 24-bit alternate bytes */
#define FURI_HAL_OSPI_ALTERNATE_BYTES_32_BITS \
...
/** @defgroup OSPI_AlternateBytesDtrMode OSPI Alternate Bytes DTR Mode
  * @{
  */
#define FURI_HAL_OSPI_ALTERNATE_BYTES_DTR_DISABLE \
    ((uint32_t)0x00000000U) /*!< DTR mode disabled for alternate bytes phase */
#define FURI_HAL_OSPI_ALTERNATE_BYTES_DTR_ENABLE \
