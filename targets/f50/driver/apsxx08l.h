...
#define APSXX08L_MR3_SRF_SR \
    (0x00U                  \
     << 5) /*!< Self Refresh Flag : Slow Refresh (allowed via MR4[3]=1, otherwise Fast Refresh)   */
...
#define APSXX08L_MR3_RBXEN_NO_SUPP \
    (0x00U << 7) /*!< Row Boundary Crossing Enable : RBX not supported          */
#define APSXX08L_MR3_RBXEN_SUPP \
    (0x01U << 7) /*!< Row Boundary Crossing Enable : RBX supported via MR8[3]=1 */

/* Mode Register 4 R/W*/
#define APSXX08L_MR4_ADDRESS 0x00000004U

#define APSXX08L_MR4_PASR 0x07U /*!< Partially Address Space Refresh     */
#define APSXX08L_MR4_PASR_FULL \
    (0x00U << 0) /*!< PASR : Full Array  		000000h-FFFFFFh 16Mx8 128Mb        */
#define APSXX08L_MR4_PASR_BOTTOM_HALF \
    (0x01U << 0) /*!< PASR : Bottom 1/2 Array    000000h-7FFFFFh 8Mx8  64Mb         */
#define APSXX08L_MR4_PASR_BOTTOM_QUART \
    (0x02U << 0) /*!< PASR : Bottom 1/4 Array    000000h-3FFFFFh 4Mx8  32Mb         */
#define APSXX08L_MR4_PASR_BOTTOM_EIGHT \
    (0x03U << 0) /*!< PASR : Bottom 1/8 Array    000000h-1FFFFFh 2Mx8  16Mb         */
#define APSXX08L_MR4_PASR_NONE \
    (0x04U << 0) /*!< PASR : None                       0        0M    0Mb          */
#define APSXX08L_MR4_PASR_TOP_HALF \
    (0x05U << 0) /*!< PASR : Top 1/2 Array       800000h-FFFFFFh 8Mx8  64Mb         */
#define APSXX08L_MR4_PASR_TOP_QUART \
    (0x06U << 0) /*!< PASR : Top 1/4 Array       C00000h-FFFFFFh 4Mx8  32Mb         */
#define APSXX08L_MR4_PASR_TOP_EIGHT \
    (0x07U << 0) /*!< PASR : Top 1/8 Array       E00000h-FFFFFFh 2Mx8  16Mb         */

#define APSXX08L_MR4_RF_MSK 0x08U /*!< Refresh Frequency           		*/
#define APSXX08L_MR4_RF_FR  (0x00U << 3) /*!< Refresh Frequency : Fast Refresh   */
#define APSXX08L_MR4_RF_SR \
    (0x01U << 3) /*!< Refresh Frequency : Enables Slow Refresh when temperature allows*/
...
#define APSXX08L_MR8_RBX_OFF \
    (0X00                    \
     << 3) /*!< Row Boundary Crossing Read Enable : Reads stay within the 1K column address space*/
#define APSXX08L_MR8_RBX_ON \
    (0x01 << 3) /*!< Row Boundary Crossing Read Enable : Reads cross row at 1K boundaries*/
