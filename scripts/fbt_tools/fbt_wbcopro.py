...
def generate(env):
    ...
    env.SetDefault(
        ...
        SELFUPDATE_SCRIPT=env.File("${FBT_SCRIPT_DIR}/selfupdate.py").rfile(),
        DIST_SCRIPT=env.File("${FBT_SCRIPT_DIR}/sconsdist.py").rfile(),
        COPRO_ASSETS_SCRIPT=env.File("${FBT_SCRIPT_DIR}/assets.py").rfile(),
    )
